...
resource "aws_ecr_repository" "playwright_api" {
  name = "${var.project_name}-playwright-api"
}
...
resource "aws_ecr_lifecycle_policy" "playwright_api" {
  repository = aws_ecr_repository.playwright_api.name
